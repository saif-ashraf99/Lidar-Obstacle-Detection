...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    ProcessPointClouds<pcl::PointXYZI>* PointProcessorI=new ProcessPointClouds<pcl::PointXYZI>();
      ...
      PointProcessor->SegmentPlane(inputCloud, 150, 0.2);
    renderPointCloud(viewer, segmentCloud.first, "obstacleCloud", Color(1,0,0));
    renderPointCloud(viewer, segmentCloud.second, "planeCloud", Color(0,1,0));
  
  	std::vector<pcl::PointCloud<pcl::PointXYZ>::Ptr> cloudClusters = PointProcessor->Clustering(segmentCloud.first, 1.0, 4, 30);
  	int clusterId = 0;
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI> pointProcessor, pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud)
{
    ...
    std::unordered_set<int> inliers = pointProcessor.RansacPlane(inputCloud, 30, 0.2);
    ...
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.euclideanCluster_clustering(cloudOutliers, 0.53,10,1000);
